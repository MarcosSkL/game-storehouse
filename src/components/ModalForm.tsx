...
import Games from '@/pages/jogos/games/[id]';
...
const ModalForm = () => {
    ...
    .then(() => {
      router.push(`/jogos/games/${id}`); // Redireciona para a página do ID específico após a inserção
        ...
        <div>
            <Modal show={showModal} onHide={() => setShowModal(false)}>
                <Modal.Header closeButton>
                    <Modal.Title>Inserir Review</Modal.Title>
                </Modal.Header>
                <Modal.Body>
