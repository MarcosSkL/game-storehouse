                ...
                {jogos.map((item: any) => (
                    <div key={item.id} className="p-2">
                        <Image
                            ...
                            className="rounded-lg shadow-lg h-screen w-full object-fill"
                        />
                        <div className="absolute bottom-[80px] text-white px-3 pl-[28px] sm:pl-[36px] md:pl-[48px] lg:pl-[60px] w-full">
                            <h2 className="font-bold text-xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl mb-3">
                                {item.titulo}
                            </h2>
                            <p className="sm:text-left sm:pr-4 sm:mb-6 text-ellipsis overflow-hidden md:text-lg">
                                {item.desenvolvedora}
                            </p>
                            <div className=" gap-5 items-center hidden sm:flex">
                                <Link href={"jogos/games/" + item.id}>
                                    <button
                                        aria-label="Detalhes"
                                        className="px-[20px] bg-[#3e3b44b3] min-h-[4px] min-w-[144px] py-[12px] rounded-[200px] text-slate-50 hover:bg-gray-400 font-semibold"
                                    >
                                        Detalhes
                                    </button>
                                </Link>
